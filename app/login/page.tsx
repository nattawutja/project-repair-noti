    ...
    <div className="bg-white min-h-screen flex flex-col justify-start items-center gap-4 pt-30 ">
      ...
      >
        ...
        <div className="flex flex-col items-center w-72 mt-5">
          ...
          <button type="submit" className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 whitespace-nowrap cursor-pointer">
